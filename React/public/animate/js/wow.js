(function() {
  let MutationObserver, Util, DayMap, getComputedStyle, getComputedStyleRX,
  ...
  DayMap = this.WeakMap || this.MozWeakMap || (DayMap = (function() {
    function DayMap() {
      this.keys = [];
      this.values = [];
    }

    DayMap.prototype.get = function(key) {
    ...
    DayMap.prototype.set = function(key, value) {
      let i, item, j, len, ref;
      ref = this.keys;
      for (i = j = 0, len = ref.length; j < len; i = ++j) {
        item = ref[i];
